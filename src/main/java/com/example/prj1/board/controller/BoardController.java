...
public class BoardController {
    ...
    @PostMapping("write")
    public String writePost(BoardForm data, @SessionAttribute(name = "loggedInUser", required = false) MemberDto user
        ...
        if (result) {
            ...
            rttr.addFlashAttribute("alert",
                    Map.of("code", "danger", "message",
                            data.getId() + "번 게시물이 수정되지 않았습니다습니다."));
        }
